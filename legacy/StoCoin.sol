...
// Sto Coin
//
// Based on IDH indaHash token public sale contract ( 
//
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
//
// StoCoin public token sale
//
// ----------------------------------------------------------------------------

contract StoCoin is ERC20Token {
  ...
  string public constant name     = "Sto Coin";
  ...
  uint public DATE_PRESALE_START = 0;
  uint public DATE_PRESALE_END   = 0;
  
  uint public DATE_ICO_START = 0;
  uint public DATE_ICO_END   = 0;
  ...
  // Demo funcs
  // new Date("November 21, 2017 22:21:00").getTime()/1000.0
  // 1511295660
  // new Date(1511295660 * 1000).toLocaleString()
  // "11/21/2017, 10:21:00 PM"

  function setDateRanges(uint _ts) onlyOwner {
    DATE_PRESALE_START = _ts;
    DATE_PRESALE_END   = _ts + 7 days;
    DATE_ICO_START     = _ts + 7 days;
    DATE_ICO_END       = _ts + 3 * 7 days;
  }

  // Information functions ------------

  // uint public fakeNow = 0;
  // function setNow(uint _now) {
  //   fakeNow = _now;
  // }
  ...
  uint public daysShift = 0;
  function setDaysShift(uint _days) {
    daysShift = _days;
  } 
  ...
  function buyTokens() private {
    ...
    // ts = 1511296500;
    // timestamps = [ 1511296200, 1511901000, 1512505800, 1513110600 ];
    // isPresale = false;
    // isIco = false;
    // DATE_PRESALE_START = timestamps[0];
    // DATE_PRESALE_END   = timestamps[1];
    // DATE_ICO_START     = timestamps[2];
    // DATE_ICO_END       = timestamps[3];
